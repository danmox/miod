import roslaunch
import rospy
from trajectories import run_custom_trajectory
from trajectories import get_data
...
id_list, trajectory_list = get_data("cfg/dictex.yaml")
for id in id_list:
    rospy.set_param('/' + dron_name + str(id) + '/' + nav_node + '/desired_trajectory', trajectory_list[id_list.index(id)])
